      ...
      <aside className="w-[240px] flex flex-col bg-[var(--sidebar-bg)] text-[var(--on-dark)] shadow-[4px_0_24px_-4px_rgba(15,23,42,0.08)]">
        <div className="px-5 pt-6 pb-5">
          <div className="flex items-center gap-3">
            <div className="relative w-8 h-8 rounded-lg bg-[var(--primary)] flex items-center justify-center">
              <div className="absolute -inset-2 bg-[var(--accent-600)]/10 rounded-full blur-xl" />
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isActive
                    ? "bg-white/[0.08] text-[var(--on-dark)]"
                    : "text-[var(--on-dark-muted)] hover:bg-white/[0.08] hover:text-[var(--on-dark)]"
                  }
                `}
              >
                <svg
                ...
                {isActive && (
                  <div className="ml-auto absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 rounded-r bg-gradient-to-b from-[var(--accent-400)] to-[var(--accent-600)]" />
                )}
              </button>
            );
          })}

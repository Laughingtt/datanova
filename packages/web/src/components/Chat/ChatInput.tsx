...
export default function ChatInput({ onSend, onNewTopic, disabled }: ChatInputProps) {
  ...
  return (
    <div className="border-t border-[var(--hairline)] bg-[var(--canvas)] p-4">
      <div className="max-w-3xl mx-auto input-well transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] focus-within:scale-[1.005]">
        <div className="input-well-inner flex items-end gap-2 px-4 py-3">
          <textarea
            ref={textareaRef}
            value={text}
